...
Blockly.ScratchBlocks.ProcedureUtils.definitionMutationToDom = function(
  ...
  container.setAttribute('proccode', this.procCode_);//this.procCode_
  container.setAttribute('argumentids', JSON.stringify(this.argumentIds_));
...
/**
 * Externally-visible function to set the warp on procedure declaration.
 * @param {boolean} return The value of the warp_ property.
 * @public
 */
Blockly.ScratchBlocks.ProcedureUtils.setReturn = function(re) {
  this.return_ = re;
};
 ...
 * @public
 */
Blockly.ScratchBlocks.ProcedureUtils.setGlobal = function(re) {
  this.global_ = re;
};
